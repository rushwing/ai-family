...
- [gemini-r2][2026-06-14] 再次：02 图示 CF Tunnel 直连 RPi，但未画 RPi→Mac Mini（K3s Ingress/外部 runtime）的路由，正文缺 Subnet Router ACL——强化 BUG-008（混合编排下尤其要明确 Pi5 作 ingress 到 Mac 的 ACL 最小化，防 Pi5 被攻破后内网全穿透）。human-001 裁决：待定
